...
find_skipped_exons <- function(study, exons_bed){
  ...
  write.table(colSums(col7_jx[1:(length(col7_jx)-2)] > 0), file = "/groups/umcg-gcc//tmp03/umcg-dvdveerdonk/number_of_junctions.csv", append = TRUE, col.names = FALSE, sep = ",")
...
not_run_studies <- c("SRP032775", "SRP056295", "SRP025982", "SRP012682", "TCGA")
